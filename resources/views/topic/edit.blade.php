                            ...
                            <div class="grid grid-cols-3 gap-6">
                                <div class="col-span-3">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="title" value="{{$topic->title}}" id="company-website" class="block w-full flex-1 rounded-md border-gray-300 focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm" placeholder="My Basecamp">
                                    </div>
                                </div>
                            </div>
                        </div>
